...
:compile
ECHO Compiling...
g++ *.cpp -o %CompiledFile% -O1 -Wall -Wextra -Wno-unused-parameter -pedantic-errors -std=c++23 -Wno-missing-braces -I include/ -I include/box2d -I ../raylib/include -L lib/ -L ../raylib/lib/ -lraylib -lopengl32 -lgdi32 -lbox2d -lwinmm
GOTO nextStep
